...
public class Forum_group1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forum_group1);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(final AdapterView<?> adapterView, View view, final int i, long l) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Forum_group1.this,R.style.AppCompatAlertDialogStyle);
    ...
    public void xcxlistrefresh(){
        ...
        alertDialogBuilder.setMessage("Do want to clear forum history?");
